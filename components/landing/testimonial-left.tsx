...
export function TestimonialLeft(props: TestimonialBlockProps) {
  const {
    vimeoId,
    title,
    name,
  ...
  /** Referenz: kompakte Meta-Zeile, kleine Sterne, Name medium, Rolle kleiner */
  const metaBlock = (
  ...
  const socialBlock =
    hasSocial && socialLinks ? (
      <Box gridArea="videoSocial" w="full" pt={{ base: "4", lg: "5" }}>
      ...
      <Container maxW={testimonialLayout.containerMaxW} px={{ base: "5", md: "8", lg: "10" }}>
        <Box
          ...
          gridTemplateAreas={{
            ...
            lg: hasSocial
              ? (`"video content" "videoSocial ."` as const)
              : (`"video content"` as const),
          }}
        >
          <VStack
            gridArea="content"
